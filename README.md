...
<details>
  ...
  [![Green Lantern](https://img.shields.io/badge/Acessar_projeto-Green_Lantern-brightgreen?style=flat-square)](/ReactNative/green-lantern/)

  ### Bat Signal App
  App de estudo de componentes e lógica em React Native, inspirado no universo Batman.
...
<details>
  <summary><strong>🌐 Projetos React / React API (DIO)</strong></summary>
